...
Spelling, grammar, factual review, quotation judgment, intentional voice, duplicate disposition, merge synthesis, and live external-link verification remain editorial responsibilities rather than blind rewrites.
...
The canonical workflow is documented in [`../EDITORIAL_WORKFLOW.md`](../EDITORIAL_WORKFLOW.md), the profile rules in [`../EDITORIAL_STANDARD.md`](../EDITORIAL_STANDARD.md), duplicate/synthesis policy in [`../DUPLICATE_POLICY.md`](../DUPLICATE_POLICY.md), and the inherited baseline in [`../CORPUS_AUDIT.md`](../CORPUS_AUDIT.md).
